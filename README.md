...
- [X] Создать макет проекта
- [X] Написать ТЗ проекта
- [] Подключить между собой весь необходимый стек технологий
- [] Придумать и реализовать внешний вид сайта
- [] Создать первую базу данных
- [] Задать первичные возможности сервиса (регистрация/авторизация, функция загрузки и выгрузки данных, добавление на сервис — *алгоритм сжатия данных*)
- [] Пойти спать
